-- migrate_pvoperadora.sql
DROP DATABASE IF EXISTS pvoperadora;
CREATE DATABASE pvoperadora CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE pvoperadora;
...
CREATE TABLE stores (
  id INT AUTO_INCREMENT PRIMARY KEY,
  cod_tienda VARCHAR(50) NOT NULL UNIQUE,
